...
Do not place DroidWebDisplay changes inside the upstream checkout. Patch files belong in `patches/scrcpy/` and are applied only to temporary build workspaces.
