/* GptBridge Main Single Drawer UI v1.0.0 */
(() => {
  'use strict';

  const VERSION = '1.0.0';
  const PIN_KEY = 'gptbridge.ui.main.singleDrawer.pinned.v1';
  const LAST_GROUP_KEY = 'gptbridge.ui.main.singleDrawer.lastGroup.v1';
  const ACCORDION_KEY = 'gptbridge.ui.main.singleDrawer.accordions.v1';
  ...
  function makeUI() {
    ...
    root.innerHTML = `
      <nav class="gb-rail" aria-label="GptBridge tools">
  ...
  window.GptBridgeSingleDrawerLab = {
    version: VERSION,
