...
async function bootstrap() {
    ...
    if (!capabilities.supported) {
        ...
        const transferController = new TransferController({
            ...
            fileBrowserTab: required("#file-browser-tab"),
            recentPicturesTab: required("#recent-pictures-tab"),
            fileBrowserControls: required("#file-browser-controls"),
            recentPicturesControls: required("#recent-pictures-controls"),
            recentPicturesRefresh: required("#recent-pictures-refresh"),
            ...
            explorerFrame: required("#explorer-frame"),
            explorerHelp: required("#explorer-help"),
