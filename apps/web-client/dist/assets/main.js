...
async function bootstrap() {
    ...
    if (!capabilities.supported) {
        ...
        const controller = new DroidWebDisplayController({
            ...
            stageHint: required("#stage-hint"),
            tabs: required("#display-tabs"),
            tabCapacity: required("#display-tab-capacity"),
            tabAdd: required("#display-tab-add"),
            ...
            displayDiagnostics: required("#display-diagnostics"),
            controlDebugSummary: required("#control-debug-summary"),
            controlDebugDownload: required("#control-debug-download"),
            controlDebugClear: required("#control-debug-clear"),
            back: required("#back"),
            home: required("#home"),
