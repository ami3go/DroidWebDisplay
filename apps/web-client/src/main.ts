...
async function bootstrap(): Promise<void> {
  ...
  if (!capabilities.supported) {
    ...
    const controller = new DroidWebDisplayController({
      ...
      stageHint: required<HTMLElement>("#stage-hint"),
