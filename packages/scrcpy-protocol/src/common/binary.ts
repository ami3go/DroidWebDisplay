...
export function readU16be(data: Uint8Array, offset = 0): number {
  return view(data, offset, 2).getUint16(0, false);
}

export function readI16be(data: Uint8Array, offset = 0): number {
  return view(data, offset, 2).getInt16(0, false);
}

export function readU32be(data: Uint8Array, offset = 0): number {
  return view(data, offset, 4).getUint32(0, false);
}

export function readI32be(data: Uint8Array, offset = 0): number {
...
function view(data: Uint8Array, offset: number, length: number): DataView {
...
export function encodeLengthPrefixedUtf8(text: string, maxBytes: number, sizeBytes: 1 | 2 | 4): Uint8Array {
...
export function floatToU16Fixed(value: number): number {
...
export function floatToI16Fixed(value: number): number {
