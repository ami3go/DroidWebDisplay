...
LAN_HTTPS = "lan-https"
DEFAULT_PORT = 8765
DEFAULT_RULE_NAME = "Gpt-Bridge LAN Access"
...
def generate_certificate(
    ...
    *,
    ...
    common_name = hostname or socket.gethostname() or "Gpt-Bridge"
    ...
    subject = issuer = x509.Name([
        x509.NameAttribute(NameOID.ORGANIZATION_NAME, "Gpt-Bridge"),
