...
6. Optional: select **+** next to the fullscreen control to open **Settings → Quick applications**, then add, remove, or reorder installed apps. Each Android device keeps its own shortcut list.
